...
export const QUESTIONS = [
  ...
  // 15
  { id: "etc", type: "ta", sec: "마지막 한마디", sn: 15, title: "마지막으로 참고했으면 하는 내용이나\n하고 싶은 이야기가 있으면 남겨주세요", sub: "수면 외 건강 고민, 생활 여건, 코칭에 바라는 점 등\n무엇이든 괜찮아요.", k: "additional_notes", ph: "예: 해외 출장이 잦아서 시차 적응이 어렵습니다 / 특별히 없습니다" },
