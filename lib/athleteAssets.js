...
const REGISTRY = [
  {
    ...
    extras: [
      ...
      { url: "/coach/asset/yuna-predeparture", label: "시차_9월 WPB", desc: "출국 전(9/10~14) 실제 일정 위에 시차 지연 프로토콜 · 영어·팬미팅·교회·야구장·짐" },
      ...
      { url: "/coach/asset/yuna-mounjaro", label: "관리_마운자로 접종", desc: "시즌 접종 캘린더 + 부작용 회피 타이밍 · 의학 근거 (전문의 상담용)" },
    ],
  },
  {
    key: "jisoo",
