...
const REGISTRY = [
  {
    ...
    extras: [
      { url: "/coach/asset/yuna-jetlag", label: "시차_8월 보스턴 (출국 전)", desc: "출국까지 위상 후퇴 스케줄 · 서울 미루기 + 기내" },
      { url: "/coach/asset/yuna-jetlag2", label: "시차_8월 보스턴 (도착 후)", desc: "비행 ~ 도착 후 이틀 · 현지 적응" },
      { url: "/coach/asset/yuna-wpb-preshift", label: "시차_9월 WPB", desc: "WPB 이동 전(9/9~13) 취침·기상 프리시프트 · 지연 방향" },
      { url: "/coach/asset/yuna-predeparture", label: "시차_9월 WPB (실제 일정)", desc: "출국 전(9/10~14) 실제 일정 위에 시차 지연 프로토콜 · 영어·팬미팅·교회·야구장·짐" },
      { url: "/coach/asset/yuna-fm-schedule", label: "대회_8월 보스턴 FM", desc: "프로암·R2 티오프별 수면·기상 설계" },
      { url: "/coach/asset/yuna-kpmg-review", label: "대회_6월 KPMG 4R 복기", desc: "실제 4라운드 루틴·성적·긴장 흐름 (전사 기반 복기)" },
    ],
  },
  {
    key: "jisoo",
    ...
    reports: [
      ...
      {
        slug: "jisoo-summer", url: "/report/view/jisoo-summer", label: "3차 수면 리포트",
        date: "2026.09", badge: "3차",
        chips: ["6–9월", "미국 출장기"],
        desc: "지난 리포트 이후 6~9월 경과 · 취침 시각과 시차",
      },
    ],
  },
];
